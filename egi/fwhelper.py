...
"""     
    A helper to generate wrapping code for a function -- to be used with exec statement ((
...
def infinite_pad( iterable, pad_value ) :     
    """ an iterator that returns the 'pad_value' after the end of the sequence """     
